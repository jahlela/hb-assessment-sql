...
SELECT models.id, models.year, brand_name, models.name FROM models JOIN brands on (models.brand_name = brands.name) WHERE brand_name = 'Pontiac';
...
SELECT brand_name, models.name FROM brands JOIN models on (brands.name = models.brand_name) WHERE year = '1964' ORDER BY models;
...
SELECT models.name, brand_name, headquarters FROM brands JOIN models on (brands.name = models.brand_name) WHERE models.name = 'Mustang';
